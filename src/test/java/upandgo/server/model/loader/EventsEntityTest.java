...
public class EventsEntityTest {
	...
	public void test_a() {
		...
		eventEntity.addEvent("201602",
				new UserEvent(new WeekTime(Day.SUNDAY, LocalTime.of(9, 0)), "test", LocalTime.of(1, 30)));
		eventEntity.addEvent("201602",
				new UserEvent(new WeekTime(Day.THURSDAY, LocalTime.of(9, 0)), "test", LocalTime.of(1, 30)));
